            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        <span class="text-blue-600">DCodeMania</span>
                    </h1>
                    ...
                    <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
                        ...
                        <div class="py-5">
                            ...
                            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">4.6</span> /5 - from 12k
                                reviews
                            </p>
                        ...
                        <div class="py-5">
                            ...
                            <p class="mt-3 text-sm text-gray-800 dark:text-gray-200">
                                <span class="font-bold">4.8</span> /5 - from 5k
                                reviews
                            </p>
            ...
            <div class="text-center">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200">
                        Browse Popular<span class="text-blue-500">
                            Brands
                        </span>
                    </h1>
                            ...
                            <div class="flex justify-between items-center">
                                <div class="flex items-center">
                                    <img class="h-[2.375rem] w-[2.375rem] rounded-full"
                                        src="{{ url('storage', $category->images) }}" alt="{{ $category->name }}" />
                                    <div class="ms-3">
                                        <h3
                    ...
                    <div class="flex flex-wrap justify-between pt-4 border-t dark:border-gray-700">
                        <div class="flex px-6 mb-2 md:mb-0">
                            ...
                            <h2 class="text-sm text-gray-500 dark:text-gray-400">
                                Rating:<span class="font-semibold text-gray-600 dark:text-gray-300">
                                    3.0</span>
                            </h2>
                        </div>
                        <div
