        ...
        <div class="relative md:flex md:items-center md:justify-between">
            ...
            >
                ...
                >
                    ...
                    >
                        <a
                            class="{{ request()->is('/') ? 'text-blue-600' : 'text-gray-500' }} font-medium py-3 md:py-6 dark:focus:outline-none"
                            href="/"
                            aria-current="page"
                            wire:navigate
                            >Home</a
                        ...
                        <a
                            class="{{ request()->is('categories') ? 'text-blue-600' : 'text-gray-500' }} font-medium hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none"
                            href="/categories"
                            wire:navigate
                        >
                            Categories
                        ...
                        <a
                            class="{{ request()->is('products') ? 'text-blue-600' : 'text-gray-500' }} font-medium hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none "
                            href="/products"
                            wire:navigate
                        >
                            Products
                        ...
                        <a
                            class="{{ request()->is('cart') ? 'text-blue-600' : 'text-gray-500' }} font-medium flex items-center hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none "
                            href="/cart"
                            wire:navigate
                        >
                            <svg
